preciso fazer uma mudança drastica no site , mudando todo o designer system as referencias sao as imagens que irei adicionar junto ao comando.

vamos em tres etapa 

primeira etapa a pagina de login para acesso ao web app

segunda etapa o dashboard e toda a pagina do treinador 

terceira etapa o dashboard e toda a pagina do aluno/atleta.

o codigo é uma referencia do que eu quero, mas nao quero que seja identico, quero que seja uma inspiração para criar algo novo e melhor.
