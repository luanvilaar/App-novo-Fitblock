  ...
  return (
    <div className="space-y-8">
      {isPercent && percentPlan.length > 0 && (
        <div className="space-y-5 rounded-[1.75rem] border border-black/6 bg-[#f8f8f8] p-6 text-black shadow-[0_4px_16px_rgba(0,0,0,0.12)]">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1 space-y-2">
                    ...
                    <div className="flex items-baseline justify-between gap-2 font-mono text-[9px] font-bold uppercase tracking-wider">
                      <span className="text-black/30">{row.percent != null ? `${row.percent}%` : "—"}</span>
      ...
      <div className="overflow-hidden rounded-[1.75rem] border border-black/6 bg-white shadow-sm">
        <div className="grid grid-cols-12 gap-2 border-b border-black/6 bg-[#f8f8f8] px-4 py-3">
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  set.is_completed ? "bg-[#f8f8f8]" : "bg-white",
                )}
              >
                <div className="col-span-2 text-center">
                  <span
                    className={cn(
                      ...
                      set.is_completed ? "text-black" : "text-black/16",
                    )}
                  >
                    {idx + 1}
                  </span>
                ...
                <div className="col-span-3">
                  <Input
                    ...
                    className="h-12 rounded-full border-black/8 bg-[#f3f3f3] text-center font-sans text-lg font-bold text-black focus:border-black"
                    inputMode="numeric"
                    disabled={readOnly}
                  />
                </div>
                ...
                <div className="col-span-4 min-w-0">
                  <div className="relative">
                    <Input
                      ...
                      className="h-12 rounded-full border-black/8 bg-[#f3f3f3] pr-6 text-center font-sans text-lg font-bold text-black focus:border-black"
                      inputMode="decimal"
                      disabled={readOnly}
                    />
                    <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 font-mono text-[7px] font-bold uppercase text-black/30">
                      kg
                    </span>
                  </div>
                </div>
                ...
                <div className="col-span-3 flex justify-center">
                  <button
                    ...
                    disabled={readOnly}
                    className={cn(
                      "flex h-12 w-12 items-center justify-center rounded-full transition-all active:scale-90 disabled:cursor-default",
                      set.is_completed
                        ? "bg-black text-white shadow-[0_4px_16px_rgba(0,0,0,0.16)]"
                        : "bg-[#f3f3f3] text-black/16 hover:text-black/40",
                    )}
                  >
                    <Check
                      className={cn(
