import { Activity, Home, LogOut, PlaySquare, User } from "lucide-react";
...
const navItems = [
  ...
  { to: "/dashboard/sessao", icon: PlaySquare, label: "Sessão" },
  { to: "/dashboard/evolucao", icon: Activity, label: "Evolução" },
